...
const sidebarNavItems = [
  {
    display: 'Match',
    icon: <img width='30' height='30' src='https://img.icons8.com/ios/50/1A1A1A/pets--v1.png' alt='pets--v1' />,
    to: '/match',
    section: 'match',
  },
  {
    display: 'Profile',
    icon: <img width='30' height='30' src='https://img.icons8.com/material-outlined/48/user--v1.png' alt='user--v1' />,
    to: '/profile',
    section: 'profile',
  },
  {
    display: 'Likes',
    icon: <img width='30' height='30' src='https://img.icons8.com/ios/50/like--v1.png' alt='like--v1' />,
    to: '/likes',
    section: 'likes',
  },
  {
    ...
    <div className={`sidebar ${x ? 'none' : ''}`}>
      <div ref={modalRef} className='shadowWrap'>
        <div className='modalOut'>
          <h4 style={{ marginBottom: 17 }}>Вы уверены, что хотите выйти?</h4>
      ...
      <div>
        ...
        <div ref={sidebarRef} className='sidebar__menu'>
          ...
          {sidebarNavItems.map((item, index) =>
            item.isModal ? (
              <div onClick={() => modalRef.current.classList.add('active')} key={index} style={{ cursor: 'pointer' }}>
      ...
      <h2 className='sloganText'>Find love friends for your four-legged friend. </h2>
    </div>
  )
}
